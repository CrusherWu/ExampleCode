...
-(void)joinCartAnimationWithRect:(CGRect)rect
{
    ...
    //三点曲线
    [_path addCurveToPoint:CGPointMake(_endPoint_x, _endPoint_y)//结束
             controlPoint1:CGPointMake(startX, startY)//开始
             controlPoint2:CGPointMake(startX - 180, startY - 200)];//经过
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag
{
    ...
    if ([[anim valueForKey:@"animationName"]isEqualToString:@"groupsAnimation"]) {
        ...
        shakeAnimation.fromValue = [NSNumber numberWithFloat:0.3];
